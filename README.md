...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cdt-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12914&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/cdt-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `cdt` can be installed with:

```
conda install cdt
```

It is possible to list all of the versions of `cdt` available on your platform with:
